...
const MainContent = () => {
    ...
    return (
        <AtrcContent>
            <AtrcPanelRow>
                <AtrcControlText
                    label={__('Setting 1', 'wp-ext-rule-pricing')}
                    placeholder={__('Enter Text', 'wp-ext-rule-pricing')}
                    value={setting1}
                    onChange={newVal =>
            ...
            <AtrcPanelRow>
                <AtrcControlText
                    label={__('Setting 2', 'wp-ext-rule-pricing')}
                    placeholder={__('Enter Another Text', 'wp-ext-rule-pricing')}
                    value={setting2}
                    onChange={newVal =>
        ...
        <AtrcWireFrameHeaderContentFooter
            ...
            renderContent={
                <>
                    ...
                    <AtrcPanelBody
                        title={__('FAQ Query 2?', 'wp-ext-rule-pricing')}
                        initialOpen={false}>
                        <AtrcText
                            tag='p'
                            className={classNames(AtrcPrefix('m-0'), 'at-m')}>
...
const Settings = () => {
    ...
    return (
        <AtrcWireFrameHeaderContentFooter
            ...
            renderHeader={
                <AtrcTitleTemplate1 title={__('Settings', 'wp-ext-rule-pricing')} />
            }
            renderContent={
                <AtrcWireFrameContentSidebar
                    wrapProps={{
