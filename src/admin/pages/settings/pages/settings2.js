...
const MainContent = () => {
    ...
    return (
        <AtrcContent>
            ...
            <AtrcPanelRow>
                <AtrcControlSelect
                    label={__('Setting 5 Select', 'wp-ext-rule-pricing')}
                    value={setting5}
                    options={[
                        {
                            label: __('Option 1', 'wp-ext-rule-pricing'),
                            value: 'option-1'
                        },
                        {
                            label: __('Option 2', 'wp-ext-rule-pricing'),
                            value: 'option-2'
                        },
                    ]}
                    onChange={newVal =>
        ...
        <AtrcWireFrameHeaderContentFooter
            ...
            renderContent={
                <>
                    ...
                    <AtrcPanelBody
                        title={__('FAQ Query 4?', 'wp-ext-rule-pricing')}
                        initialOpen={false}>
                        <AtrcText
                            tag='p'
                            className={classNames(AtrcPrefix('m-0'), 'at-m')}>
