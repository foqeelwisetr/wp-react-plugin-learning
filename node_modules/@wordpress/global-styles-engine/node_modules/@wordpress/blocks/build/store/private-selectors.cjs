...
// packages/blocks/src/store/private-selectors.ts
...
var getSupportedStyles = (0, import_data.createSelector)(
  (state, name, element) => {
    ...
    const stylePropertyMap = import_constants.__EXPERIMENTAL_STYLE_PROPERTY;
    Object.keys(stylePropertyMap).forEach((styleName) => {
      ...
      if (stylePropertyMap[styleName].requiresOptOut) {
        if (supports && stylePropertyMap[styleName].support[0] in supports && (0, import_utils.getValueFromObjectPath)(
          supports,
      ...
      if (supports && (0, import_utils.getValueFromObjectPath)(
        supports,
        stylePropertyMap[styleName].support,
        false
      )) {
