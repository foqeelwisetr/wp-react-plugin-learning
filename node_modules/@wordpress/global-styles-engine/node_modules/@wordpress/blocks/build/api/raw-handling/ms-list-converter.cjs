...
// packages/blocks/src/api/raw-handling/ms-list-converter.ts
...
function msListConverter(node, doc) {
  ...
  listItem.innerHTML = (0, import_utils.deepFilterHTML)(element.innerHTML, [import_ms_list_ignore.default]);
