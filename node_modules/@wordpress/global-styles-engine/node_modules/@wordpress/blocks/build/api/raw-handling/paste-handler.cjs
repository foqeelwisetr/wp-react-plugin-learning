...
// packages/blocks/src/api/raw-handling/paste-handler.ts
...
function filterInlineHTML(HTML) {
  ...
  HTML = (0, import_dom.removeInvalidHTML)(
    HTML,
    (0, import_dom.getPhrasingContentSchema)("paste"),
    true
  );
...
function pasteHandler({
  ...
  const blocks = pieces.map((piece) => {
    ...
    piece = (0, import_dom.removeInvalidHTML)(piece, schema, false);
