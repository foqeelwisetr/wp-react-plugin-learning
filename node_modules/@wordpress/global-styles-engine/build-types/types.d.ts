 ...
 */
export type UnresolvedValue = string | number | {
    ref: string;
} | {
    url: string;
} | undefined | null;
...
export interface GlobalStylesSettings {
    ...
    custom?: Record<string, string | number | Record<string, string | number>>;
...
export interface GlobalStylesStyles {
    ...
    elements?: Record<string, Omit<GlobalStylesStyles, 'blocks' | 'elements' | 'variations'> & {
        ':hover'?: Omit<GlobalStylesStyles, 'blocks' | 'elements' | 'variations'>;
    }>;
