 ...
 */
export declare function hasRevision(state: State, kind: string, name: string, recordKey: EntityRecordKey, revisionKey: EntityRecordKey, query?: GetRecordsHttpQuery): boolean;
/**
