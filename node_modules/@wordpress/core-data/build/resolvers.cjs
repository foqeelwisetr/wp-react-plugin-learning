...
var getViewConfig = (kind, name) => async ({ dispatch }) => {
  const config = await (0, import_api_fetch.default)({
    path: (0, import_url.addQueryArgs)("/wp/v2/view-config", { kind, name })
  });
