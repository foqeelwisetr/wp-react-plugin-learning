...
var BlockMoverButton = (0, import_element.forwardRef)(
  ({ clientIds, direction, orientation: moverOrientation, ...props }, ref) => {
    ...
    const normalizedClientIds = (0, import_element.useMemo)(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ui.VisuallyHidden, { id: descriptionId, children: (0, import_mover_description.getBlockMoverDescription)(
        blocksCount,
