...
function FitTextFontSize({ fitText, name, clientId, isSelected }) {
  ...
  if (isSelected && fontSize && fontSize < MIN_FONT_SIZE_FOR_WARNING) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_inspector_controls.default, { group: "typography", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_fit_text_size_warning.default, {}) });
  }
  return null;
}
var addFitTextControl = (0, import_compose.createHigherOrderComponent)((BlockEdit) => {
  return function AddFitTextControl(props) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_inspector_controls.default, { group: "typography", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        FitTextControl,
        {
          clientId,
          fitText,
