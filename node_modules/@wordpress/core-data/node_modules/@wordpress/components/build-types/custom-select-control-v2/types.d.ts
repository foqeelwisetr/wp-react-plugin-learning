...
export type CustomSelectContext = (CustomSelectStore & CustomSelectButtonSize) | undefined;
export type CustomSelectButtonProps = {
     ...
     */
    renderSelectedValue?: (selectedValue: string | readonly string[]) => React.ReactNode;
    /**
