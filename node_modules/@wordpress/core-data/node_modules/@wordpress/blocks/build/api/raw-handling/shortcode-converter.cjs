...
// packages/blocks/src/api/raw-handling/shortcode-converter.ts
...
function segmentHTMLToShortcodeBlock(HTML, lastIndex = 0, excludedBlockNames = []) {
  const transformsFrom = (0, import_factory.getBlockTransforms)(
    "from"
  );
  const transformation = (0, import_factory.findTransform)(
    ...
    ((transform) => {
      const t = transform;
      return excludedBlockNames.indexOf(t.blockName) === -1 && t.type === "shortcode" && castArray(t.tag).some(
