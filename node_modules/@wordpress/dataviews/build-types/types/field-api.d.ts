...
export type Operator = 'is' | 'isNot' | 'isAny' | 'isNone' | 'isAll' | 'isNotAll' | 'lessThan' | 'greaterThan' | 'lessThanOrEqual' | 'greaterThanOrEqual' | 'before' | 'after' | 'beforeInc' | 'afterInc' | 'contains' | 'notContains' | 'startsWith' | 'between' | 'on' | 'notOn' | 'inThePast' | 'over';
export type FieldTypeName = 'text' | 'integer' | 'number' | 'datetime' | 'date' | 'media' | 'boolean' | 'email' | 'password' | 'telephone' | 'color' | 'url' | 'array';
export type Rules<Item> = {
    ...
    min?: number | string;
    max?: number | string;
    custom?: ((item: Item, field: NormalizedField<Item>) => null | string) | ((item: Item, field: NormalizedField<Item>) => Promise<null | string>);
};
export type Validator<Item> = (item: Item, field: NormalizedField<Item>) => boolean;
export type CustomValidator<Item> = ((item: Item, field: NormalizedField<Item>) => null | string) | ((item: Item, field: NormalizedField<Item>) => Promise<null | string>);
export type FilterOperator<Item> = (item: Item, field: NormalizedField<Item>, filterValue: any) => boolean;
export type FilterOperatorMap<Item> = Partial<Record<Operator, FilterOperator<Item>>>;
 ...
 */
export type EditConfig = EditConfigTextarea | EditConfigText | EditConfigDatetime | EditConfigGeneric;
...
export type NormalizedField<Item> = Omit<Field<Item>, 'Edit' | 'isValid'> & {
    label: string;
    header: string | ReactElement;
    getValue: (args: {
        item: Item;
    ...
    format: {} | Required<FormatDate> | Required<FormatInteger> | Required<FormatNumber>;
    getValueFormatted: ({ item, field, }: {
        item: Item;
        field: NormalizedField<Item>;
    }) => string;
...
export {};
//# sourceMappingURL=field-api.d.ts.map