...
export declare const VIEW_LAYOUTS: ({
    type: string;
    label: import("@wordpress/i18n").TransformedText<"Table">;
    ...
    type: string;
    label: import("@wordpress/i18n").TransformedText<"Grid">;
    ...
    type: string;
    label: import("@wordpress/i18n").TransformedText<"List">;
    ...
    type: string;
    label: import("@wordpress/i18n").TransformedText<"Activity">;
