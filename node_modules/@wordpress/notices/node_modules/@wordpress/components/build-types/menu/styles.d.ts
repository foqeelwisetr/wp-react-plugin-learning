...
export declare const Menu: import("@emotion/styled").StyledComponent<Ariakit.MenuOptions<"div"> & Omit<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref"> & {
...
export declare const MenuSurface: import("@emotion/styled").StyledComponent<{
    theme?: import("@emotion/react").Theme;
 ...
 * surface via `:has(> …)`.
 */
export declare const MenuMotionRoot: import("@emotion/styled").StyledComponent<{
    theme?: import("@emotion/react").Theme;
    as?: React.ElementType;
