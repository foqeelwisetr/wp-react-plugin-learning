...
export type PortalProps = ComponentPropsWithoutRef<typeof _Autocomplete.Portal>;
export type AutocompleteClearProps = ComponentProps<typeof _Autocomplete.Clear> & {
    children?: React.ReactNode;
};
export type AutocompleteEmptyProps = ComponentProps<typeof _Autocomplete.Empty> & {
    children?: React.ReactNode;
};
export type AutocompleteInputProps = Omit<ComponentProps<typeof _Autocomplete.Input>, 'size'>;
export type AutocompleteInputGroupProps = ComponentProps<typeof _Autocomplete.InputGroup> & {
    children?: React.ReactNode;
};
export type AutocompleteItemProps = ComponentProps<typeof _Autocomplete.Item> & {
    children?: React.ReactNode;
};
export type AutocompleteListProps = ComponentProps<typeof _Autocomplete.List> & {
    children?: _Autocomplete.List.Props['children'];
};
export type AutocompleteListBodyProps = ComponentProps<'div'> & {
    children?: React.ReactNode;
};
export type AutocompletePopupProps = ComponentProps<typeof _Autocomplete.Popup> & {
    children?: React.ReactNode;
    /**
