// packages/ui/src/form/primitives/autocomplete/popup.tsx
...
// packages/ui/src/form/primitives/autocomplete/style.module.css
if (typeof document !== "undefined" && process.env.NODE_ENV !== "test" && !document.head.querySelector("style[data-wp-hash='b480cdecca']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "b480cdecca");
  style.appendChild(document.createTextNode("@layer wp-ui-utilities, wp-ui-components, wp-ui-compositions, wp-ui-overrides;@layer wp-ui-components{._8eb0a29484225eea__positioner{z-index:var(--wp-ui-autocomplete-z-index,initial)}}"));
  document.head.appendChild(style);
}
var style_default = { "positioner": "_8eb0a29484225eea__positioner" };
...
var Popup = forwardRef(
  function Popup2({ className, portal, ...restProps }, ref) {
    const portalChildren = /* @__PURE__ */ jsx(
      _Autocomplete.Positioner,
      {
        ...
        children: /* @__PURE__ */ jsx(ThemeProvider, { children: /* @__PURE__ */ jsx(
          ...
          {
            ref,
            className: clsx(item_popup_default.popup, className),
            ...restProps
          }
        ) })
      }
    );
    return renderPortalWithChildren(portal, /* @__PURE__ */ jsx(Portal, {}), portalChildren);
  }
);
export {
  Popup
