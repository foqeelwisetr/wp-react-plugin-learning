...
if (typeof document !== "undefined" && process.env.NODE_ENV !== "test" && !document.head.querySelector("style[data-wp-hash='2feedc57ba']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "2feedc57ba");
...
var Popup = forwardRef(
  function Popup2({ className, portal, children, ...restProps }, ref) {
