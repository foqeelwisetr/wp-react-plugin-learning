...
import { SCROLL_CONTAINER_ATTR } from "../utils/use-overlay-scroll-state-attributes.mjs";
import { renderPortalWithChildren } from "../utils/render-portal-with-children.mjs";
import { DrawerValidationProvider, useDrawerModal } from "./context.mjs";
...
var Popup = forwardRef(function DrawerPopup({ className, portal, children, size, initialFocus, finalFocus, ...props }, ref) {
  ...
  const portalChildren = /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(_Drawer.Viewport, { className: style_default.viewport, children: /* @__PURE__ */ jsx(ThemeProvider, { children: /* @__PURE__ */ jsx(
      _Drawer.Popup,
      {
        ref: mergedRef,
        className: (state) => {
        ...
        children: /* @__PURE__ */ jsx(DrawerValidationProvider, { children })
      }
    ) }) })
  ] });
