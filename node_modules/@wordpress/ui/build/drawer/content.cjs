...
// packages/ui/src/drawer/content.tsx
var content_exports = {};
...
var Content = (0, import_element.forwardRef)(
  function DrawerContent({ className, children, onScroll, ...props }, ref) {
    const { ref: scrollStateRef, onScroll: scrollStateOnScroll } = (0, import_use_overlay_scroll_state_attributes.useOverlayScrollStateAttributes)(onScroll);
    const mergedRef = (0, import_compose.useMergeRefs)([ref, scrollStateRef]);
