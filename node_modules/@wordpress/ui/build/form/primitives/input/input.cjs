...
if (typeof document !== "undefined" && process.env.NODE_ENV !== "test" && !document.head.querySelector("style[data-wp-hash='9703c077a9']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "9703c077a9");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_input_layout.InputLayout,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        {
          ref,
          className: (0, import_clsx.default)(global_css_defense_default.input, style_default.input),
          ...restProps
        }
      )
    }
