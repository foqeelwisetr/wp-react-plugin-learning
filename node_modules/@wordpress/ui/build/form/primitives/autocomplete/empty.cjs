...
// packages/ui/src/form/primitives/autocomplete/empty.tsx
var empty_exports = {};
...
var Empty = (0, import_element.forwardRef)(
  function Empty2({ className, ...restProps }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_autocomplete.Autocomplete.Empty,
      {
        className: (0, import_clsx.default)(item_popup_default.empty, className),
        ref,
        ...restProps
      }
    );
