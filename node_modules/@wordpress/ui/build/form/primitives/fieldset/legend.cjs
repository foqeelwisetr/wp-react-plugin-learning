...
if (typeof document !== "undefined" && process.env.NODE_ENV !== "test" && !document.head.querySelector("style[data-wp-hash='f9ecc2af7d']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "f9ecc2af7d");
...
var FieldsetLegend = (0, import_element.forwardRef)(
  function FieldsetLegend2({ className, hideFromVision, ...restProps }, ref) {
    const legend = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_fieldset.Fieldset.Legend,
      {
        ref,
        className: (0, import_clsx.default)(field_default.label, className),
        ...restProps
      }
    );
    if (hideFromVision) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_visually_hidden.VisuallyHidden, { render: legend });
    }
    return legend;
  }
);
