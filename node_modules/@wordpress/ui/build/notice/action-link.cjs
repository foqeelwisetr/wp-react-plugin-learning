...
if (typeof document !== "undefined" && process.env.NODE_ENV !== "test" && !document.head.querySelector("style[data-wp-hash='60dd1d4d42']")) {
  ...
  function NoticeActionLink({ className, render, ...props }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_text.Text,
      {
        ...
        ...props,
        variant: "body-md",
        render: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_link.Link, { tone: "neutral", variant: "default", render })
      }
    );
  }
);
