...
// packages/ui/src/empty-state/visual.tsx
var visual_exports = {};
__export(visual_exports, {
  Visual: () => Visual
});
module.exports = __toCommonJS(visual_exports);
...
// packages/ui/src/empty-state/visual.tsx
var Visual = (0, import_element.forwardRef)(
  function EmptyStateVisual({ render, ...props }, ref) {
    const className = (0, import_clsx.default)(style_default.visual);
    const element = (0, import_react.useRender)({
      defaultTagName: "div",
      render,
      ref,
      props: (0, import_react.mergeProps)({ className }, props)
    });
    return element;
  }
);
