...
var import_visual = require("./visual.cjs");
...
var Icon = (0, import_element.forwardRef)(
  function EmptyStateIcon({ icon, className, ...restProps }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_visual.Visual,
      {
        ref,
        className: (0, import_clsx.default)(style_default.icon, className),
        ...restProps,
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icon.Icon, { icon })
      }
    );
  }
);
