 ...
 */
export declare function vipsBatchResizeImage(id: ItemId, buffer: ArrayBuffer, inputType: string, outputType: string, resizes: Array<{
    resize: ImageSizeCrop;
    quality: number;
}>, smartCrop?: boolean): Promise<Array<{
    buffer: ArrayBuffer | ArrayBufferLike;
    width: number;
    height: number;
    originalWidth: number;
